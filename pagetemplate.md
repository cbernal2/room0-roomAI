...
<header> 
	...
	<nav> <!-- NAVIGATION BAR --->
		<ul> 
			<li><a href="index.html" class="active">Home</a></li> <!-- !CHANGE ACTIVE ON EACH PAGE! -->
			<li><a href="about.html">About</a></li>
			<li><a href="wardrobe.html">Collections</a></li>
...
<br><br> <!-- breaks to add spacing under header -->
...
<main> 
	<p> this is where the "main" content goes :P</p> 


<p> more words and stuff go here </p> 
